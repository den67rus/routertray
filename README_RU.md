...
1. Запустите RouterTray. Если пользовательского файла настроек ещё нет, автоматически откроется мастер первоначальной настройки.
2. Пройдите пять шагов: подготовьте роутер, выберите автоматическое определение шлюза или укажите URL, задайте способ входа, проверьте регистрацию MAC-адреса устройства и протестируйте подключение.
3. Если MAC-адрес не зарегистрирован, мастер предложит имя и добавит устройство в список известных хостов роутера. Для локально назначенного адреса мастер предупредит о возможной рандомизации MAC в Windows.
4. Нажмите **Завершить настройку**. Профиль сохранится, а RouterTray переместится в область уведомлений Windows.
5. Чтобы добавить другие профили, нажмите правой кнопкой на синий значок **R** и выберите **Настройки**. Значок может быть спрятан в меню дополнительных значков.
